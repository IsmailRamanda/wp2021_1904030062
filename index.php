...
<div class="row mt-4">
  ...
  <tbody>
      <?php $no = 1?>
      <?php foreach ($camaba as $cmba):?>
    <tr>
    <th scope="row"><?php echo $no; ?></th>
      <td><?php echo $cmba['nama']; ?></td>
      <td><img src="image/<?php echo $cmba['foto_maba']; ?>" width="90px" alt=""></td>
      <td><a href="detail.php?id<?=$cmba['id'];?>" class="btn btn-warning" role="button">Detail</a></td>
    </tr>
    <?php $no++?>
    <?php endforeach?>
  </tbody>
