...
<div class="row mt-4">
  ...
  <li class="nav-item">
    ...
    <div class="col-md-10 p-5 pt-5">
        <!-- content -->
        <h3><i class="fas fa-user"></i> Detail Data Calon Mahasiswa</h3><hr> 
        <ul class="list-group-item">
            <li class="list-group-item"><img src="image/foto1.jpg" width ="200px"alt=""> </li>
            <li class="list-group-item active">Nama : bambang pamungkas</li>
            <li class="list-group-item">alamat : kemanggisan raya</li>
            <li class="list-group-item">jenis kelamin : laki-laki</li>
            <li class="list-group-item">agama : islam</li>
            <li class="list-group-item">asal sekolah :SMAN 6</li>
