...
<div class="row mt-4">
  ...
  <li class="nav-item">
    <a class="nav-link text-white" href="#"><i class="fas fa-user"></i> calon mahasiswa</a><hr class="bg-dark">
  </li>
  </li>
  <li class="nav-item">
    <a class="nav-link text-white" href="#"><i class="fas fa-user-edit"></i> input camaba</a><hr class="bg-dark">
  </li>
  </li>
  <li class="nav-item">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><img src="image/foto1.jpg" width="90px" alt=""></td>
