...
<div class="row mt-4">
  ...
  <li class="nav-item">
    <a class="nav-link text-white" href="dosen.php"><i class="fas fa-chalkboard-teacher"></i> daftar dosen</a><hr class="bg-dark">
  </li>
  </li>
  <li class="nav-item">
    ...
    <div class="col-md-10 p-5 pt-5">
        <!-- content -->
        <h3><i class="fas fa-user"></i> Detail Dosen</h3><hr> 
        <ul class="list-group-item">
            <li class="list-group-item"><img src="image/foto1.jpg" width ="200px"alt=""> </li>
            <li class="list-group-item">Nama : dadang sujana</li>
            <li class="list-group-item">nidn : 19203618</li>
            <li class="list-group-item">jenis kelamin : laki-laki</li>
            <li class="list-group-item">alamat rumah:pegangsaan raya</li>
            <li class="list-group-item">agama : islam</li>
            <li class="list-group-item">pendidikan s1 : universitas harapan pelita</li>
            <li class="list-group-item">pendidikan s2 :universitas harapan pelita</li>
            <li class="list-group-item">pendidikan s3:-</li>

            <li class="list-group-item">
            <a href="hapus.php?id<?=$cmba['id'];?>" class="btn btn-danger" role="button">Hapus</a>
